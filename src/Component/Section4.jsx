...
const Section4 = () => {
    return (
        <div className='my-5 p-3 border-4 rounded-2xl border-green-700'>
            <h1 className='text-center text-4xl font-bold my-5'>What Makes <span className='text-green-700'>SportNest</span> Special</h1>
